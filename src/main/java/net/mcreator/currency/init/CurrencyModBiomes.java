...
import net.mcreator.currency.world.biome.HyrionDesertsBiome;
...
public class CurrencyModBiomes {
	public static final DeferredRegister<Biome> REGISTRY = DeferredRegister.create(ForgeRegistries.BIOMES, CurrencyMod.MODID);
	public static final RegistryObject<Biome> HYRION_DESERTS = REGISTRY.register("hyrion_deserts", () -> HyrionDesertsBiome.createBiome());
		...
		for (Map.Entry<ResourceKey<LevelStem>, LevelStem> entry : worldGenSettings.dimensions().entrySet()) {
			...
			if (dimensionType == dimensionTypeRegistry.getOrThrow(DimensionType.OVERWORLD_LOCATION)) {
				...
				if (chunkGenerator.getBiomeSource() instanceof MultiNoiseBiomeSource noiseSource) {
					...
					parameters.add(new Pair<>(HyrionDesertsBiome.PARAMETER_POINT,
							biomeRegistry.getOrCreateHolder(ResourceKey.create(Registry.BIOME_REGISTRY, HYRION_DESERTS.getId()))));
